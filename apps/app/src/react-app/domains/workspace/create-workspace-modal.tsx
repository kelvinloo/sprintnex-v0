...
import { modalBodyClass, pillGhostClass, tagClass } from "./modal-styles";
import { WorkspaceOptionCard } from "./option-card";
import type { CreateWorkspaceModalProps, CreateWorkspaceScreen } from "./types";
...
export function CreateWorkspaceModal(props: CreateWorkspaceModalProps) {
  ...
  const setProjectLabel = (value: SetStateAction<string>) =>
    setLocal("projectLabel", value);
