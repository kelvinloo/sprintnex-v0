    ...
    <div className="mx-auto mb-2 w-full max-w-md">
      <svg viewBox="0 0 400 260" className="w-full" aria-hidden="true">
        ...
        <g
          ...
          style={{ opacity: config.sidebar ? 1 : 0.1 }}
        >
          <rect
            x="0.5"
            y="31"
        ...
        <g
          className="transition-all duration-300"
          style={{ opacity: config.starterCards ? 1 : 0 }}
        >
          {[
            ...
            return (
              <g key={i}>
                <rect
                  ...
                  strokeWidth="0.5"
                />
                <text x={card.x + 6} y="133" fontSize="7">
                  {card.icon}
                </text>
                <text
                  x={card.x + 16}
        ...
        <g
          className="transition-all duration-300"
          style={{ opacity: config.statusBar ? 1 : 0.08 }}
        >
          <line
            x1="0"
            y1="226"
        ...
        <g
          className="transition-all duration-300"
          style={{ opacity: config.browser ? 1 : 0 }}
        >
          <line
            x1={cx + cw - 120}
            y1="31"
...
function CloudOnlyBadge() {
  return (
    <span
      className="inline-flex items-center gap-1 rounded-md bg-dls-hover size-5 justify-center text-xs font-medium text-dls-secondary"
...
export function ShellCustomizationView() {
  ...
  const applicationMenuVisible = useUiStateStore(
    (state) => state.applicationMenuVisible,
  );
  const setApplicationMenuVisible = useUiStateStore(
    (state) => state.setApplicationMenuVisible,
  );

  const isDefault =
    (Object.keys(DEFAULT_SHELL_CONFIG) as (keyof ShellConfig)[]).every(
  ...
  return (
    <LayoutStack>
      ...
      <LayoutSection>
        ...
        <LayoutSectionItem>
            ...
            <LayoutSectionItemHeaderActions>
              <Field className="w-64 max-w-full gap-0">
                ...
                <Input
                  ...
                  value={brandAppName}
                  placeholder="Sprintnex"
                  disabled
                  onChange={(event) =>
                    update({
                      appName:
                        event.currentTarget.value ||
                        DEFAULT_SHELL_CONFIG.appName,
                    })
                  }
                />
              </Field>
          ...
          <Alert>
            <Info />
            <AlertDescription>
              {brandAppName === "Sprintnex"
                ? "Your organization has not set a custom application name."
                : "This application name is managed by your organization."}
            </AlertDescription>
          </Alert>
        </LayoutSectionItem>
      </LayoutSection>
      ...
      <LayoutSection>
        ...
        <Alert>
          <AlertDescription>
            Anything you hide is still available via the command palette
            (Cmd+K).
          </AlertDescription>
        </Alert>
      ...
      <LayoutSection>
        ...
        <Alert variant="warning">
          <Lock />
          <AlertDescription>
            These settings can only be changed by your organization admin.
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-dls-secondary">
          {isDefault
            ...
            : "Some settings have been customized."}
        </div>
        <Button
          variant="outline"
          size="sm"
