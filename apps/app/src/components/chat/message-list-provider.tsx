...
interface MessageListContextValue {
  ...
  onSaveTestPlan?: (messageId: string, text: string) => void;
}

const MessageListContext = React.createContext<MessageListContextValue | null>(
  null,
);
...
export function useSessionErrorMessage() {
  ...
  return useSessionActivityStore((state) =>
    state.getSessionError(workspaceId, sessionId),
  );
}
