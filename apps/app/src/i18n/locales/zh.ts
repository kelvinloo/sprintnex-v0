...
export default {
  ...
  "settings.environment.footer_hint": "SPRINTNEX_ 和 OPENCODE_ 键名保留给应用/运行时使用。OpenCode 运行时设置请通过 shell 配置。",
  ...
  "settings.environment.validation_reserved": "SPRINTNEX_ 和 OPENCODE_ 名称由 OpenWork/OpenCode 管理。",
  ...
  "settings.reset_openwork_desc_dev": "在开发模式下，仅清除sprintnex-dev-data中的隔离OpenCode开发状态。",
  "settings.reset_openwork_desc_prod": "在开发模式下，仅清除sprintnex-dev-data中的隔离OpenCode开发状态。",
