...
export default {
  ...
  "settings.reset_openwork_desc_dev": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de sprintnex-dev-data.",
  "settings.reset_openwork_desc_prod": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de sprintnex-dev-data.",
