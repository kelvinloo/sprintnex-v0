...
const ENV_POSTHOG_HOST = String(import.meta.env.VITE_SPRINTNEX_POSTHOG_HOST ?? "").trim();
...
// unless VITE_SPRINTNEX_POSTHOG_KEY is set. Set it to "" to disable analytics
// in any build. The inspector mirror still records events locally either way.
const POSTHOG_KEY = resolvePosthogKey(import.meta.env.VITE_SPRINTNEX_POSTHOG_KEY, import.meta.env.DEV);
