  ...
  [
    {
      schemaVersion: 1,
      id: "openwork-browser",
      name: "Sprintnex Browser",
      description:
        "Automate the built-in browser panel that stays visible inside Sprintnex.",
      source: { format: "openwork-builtin", origin: "builtin", trusted: true },
      icon: { src: "/openwork-mark.svg" },
      composer: { prompt: "Use the Sprintnex Browser extension to " },
      setup: {
        instructions:
          "Sprintnex Browser is ready by default in desktop workspaces.",
      },
      resources: [
        {
      ...
      contributions: [
        ...
        },
        {
          ...
          ref: "openwork.browser.panel",
          location: "session-right-pane",
        },
        {
          type: "composer-prompt",
          prompt: "Use the Sprintnex Browser extension to ",
          location: "composer",
        },
      ],
      enablement: [
      ...
      contributions: [
        {
          ...
          ref: "openwork.computerUse.setup",
          location: "settings-detail",
        },
        {
          type: "native-capability",
          ref: "openwork.computerUse.axPermissions",
          label: "Accessibility and Screen Recording",
        },
        {
          type: "test-action",
          ref: "openwork.computerUse.healthCheck",
          label: "Verify Computer Use MCP",
        },
        {
          type: "composer-prompt",
    ...
    },
    {
      ...
      setup: {
        instructions:
          "Add an OpenAI API key, then agents can generate image artifacts through OpenWork extension actions.",
      ...
      resources: [
        ...
        {
          type: "local-service",
          id: "openai-image-generation-service",
      ...
      contributions: [
        {
          type: "settings-panel",
          ref: "openwork.imageGen.settings",
          location: "settings-detail",
        },
        {
          type: "test-action",
          ref: "openwork.imageGen.testGenerate",
    ...
    },
    {
      ...
      name: "Voice Mode",
      description:
        "Talk to OpenWork through a Realtime voice panel that drives the same semantic UI controls as OpenWork UI MCP.",
      preview: true,
      source: { format: "openwork-builtin", origin: "builtin", trusted: true },
      icon: { src: "/openwork-mark.svg" },
      ...
      setup: {
        instructions:
          "Voice Mode uses OpenAI Realtime. Save an OpenAI API key in OpenWork env vars, then open the session rail panel and speak or send a typed voice command.",
      ...
      resources: [
        ...
        {
          type: "local-service",
          id: "openwork-voice-realtime-session",
          label: "Realtime client-secret minting",
          required: true,
        },
      ],
      contributions: [
        {
          type: "settings-panel",
          ref: "openwork.voice.settings",
          location: "settings-detail",
        },
        {
          type: "session-side-panel",
          ref: "openwork.voice.panel",
          location: "session-right-pane",
        },
        {
          type: "session-rail-item",
          ref: "openwork.voice.rail",
          label: "Voice Mode",
        ...
        {
          type: "test-action",
          ref: "openwork.voice.testRealtime",
          label: "Test Realtime",
        },
        {
          type: "composer-prompt",
    ...
    },
    {
      ...
      description:
        "Let OpenWork help with meetings, selected Drive files, and Gmail drafts.",
      preview: true,
      source: { format: "openwork-builtin", origin: "builtin", trusted: true },
      ...
      setup: {
        instructions:
          "Connect your Google account to use Calendar, Drive, and Gmail drafts in OpenWork.",
      ...
      resources: [
        ...
        {
          type: "tool",
          id: "google-gmail-drafts",
          label: "Gmail drafts",
          required: true,
        },
        {
          type: "tool",
          id: "google-drive-selected-files",
        ...
        },
        {
          ...
          label: "Gmail read (opt-in)",
          required: false,
        },
        {
          type: "tool",
          id: "google-drive-full",
          label: "Full Drive access (opt-in)",
          required: false,
        },
        {
          type: "tool",
          id: "google-calendar-events",
          label: "Calendar events (opt-in)",
          required: false,
        },
        {
          type: "tool",
          id: "google-chat",
          label: "Google Chat (opt-in)",
          required: false,
        },
      ],
      contributions: [
        {
          type: "settings-panel",
          ref: "openwork.googleWorkspace.settings",
          location: "settings-detail",
        },
        {
          type: "test-action",
          ref: "openwork.googleWorkspace.testConnection",
          label: "Test Google Workspace",
        },
        {
          type: "composer-prompt",
          prompt: "Use Google Workspace to ",
          location: "composer",
        },
      ],
      lifecycle: {
        reload: ["config"],
        detection: ["provider:google-workspace"],
      },
    },
    {
      schemaVersion: 1,
      ...
      setup: {
        instructions:
          "Run Ollama locally, choose or pull a model, then add it as an OpenCode provider.",
      ...
      contributions: [
        {
          type: "settings-panel",
          ref: "openwork.ollama.settings",
          location: "settings-detail",
        },
        {
          type: "test-action",
          ref: "openwork.ollama.listModels",
