...
7. If releasing sprintnex-orchestrator sidecars, build deterministically with `SOURCE_DATE_EPOCH`, upload assets to `sprintnex-orchestrator-vX.Y.Z`, and publish `sprintnex-orchestrator`.
8. If the `sprintnex-server` version changed, publish that package.
